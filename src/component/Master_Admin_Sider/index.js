...
class MasterAdminSiderDasboardBase extends Component {
  constructor(props) {
    super(props);
          ...
          {links && links.map((item, index) => {
            return (
              <Menu.Item key={item.link.link}>
                <Link key={index} to={`/master-admin/${item.link.link}`}>
...
const MasterAdminSiderDasboard = withRouter(withFirebase(MasterAdminSiderDasboardBase));

export default MasterAdminSiderDasboard;
