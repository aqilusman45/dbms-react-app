...
import { Col, Row, Input, Select, Icon, PageHeader, Button, Modal } from 'antd';
...
class ViewMemberBase extends React.Component {
    constructor(props) {
        super(props)
    ...
    componentDidMount() {
        Axios.get(`http://localhost:3002/members/get-member/${this.props.match.params.id}`)
            .then((res) => {
                console.log(res.data.result);
                var userData = res.data.result[0]
                this.setState({
                    ...userData,
                    avalability: userData.avalability === 1 ? true : false,
                    medical_allowance: userData.medical_allowance === 1 ? true : false,
                    conveyance: userData.conveyance === 1 ? true : false,
                    accomadation_allocated: userData.accomadation_allocated === 1 ? true : false
                })
            })
            .catch((rej) => {
    ...
    handleOk = e => {
        Axios.post(`http://localhost:3002/members/delete-member/${this.props.match.params.id}`)
        .then((res)=>{
    ...
    handleUpdate = e => {
        ...
        if (this.state.academics_qualifications === '') {
            ...
            Axios.post(`http://localhost:3002/members/update-member/${this.props.match.params.id}`, {
            ...
            <Row >
                ...
                <Col className="route-height">
                    <PageHeader
                        ...
                        title={<BackIcon icon={"desktop"} color="white" title={"Member Details"} />}
                        ...
                        <div className="create-new-page-form-wrapper">
                            <form className="create-new-page-form" layout="vertical">
                                ...
                                >
                                    ...
                                    <Button style={{ margin: "0 10px" }} onClick={this.handleUpdate} type="primary">
                                        Update
                                        </Button>
...
const ViewMember = withRouter(ViewMemberBase);
