...
class FileManagerBase extends Component {
    constructor(props) {
        super(props)
        this.state = {
            isUploading: false,
                ...
                >
                    ...
                    <Tabs>
                        <TabPane tab="Images" key="1">
                            <div className="gallery">
                                <ImageGallery setFileInfo={this.setFileInfo} files={this.state.files} />
                            </div>
                        </TabPane>
                        <TabPane tab="Files" key="2">
                            <FilesGallery setFileInfo={this.setFileInfo} files={this.state.files} />
                        </TabPane>
                    </Tabs>
                    <div className="file-info-feilds">
                        <div>
                            ...
                            <input style={{ width: "80%" }} value={this.state.fileUrl} />
                        </div>
                        <div>
                            <p>File Name</p>
...
const FileManager = withFirebase(FileManagerBase);
