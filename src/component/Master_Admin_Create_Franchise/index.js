...
class CreateFranchiseBase extends Component {
    constructor(props) {
        super(props);
    ...
    onSubmit = e => {
        if (this.state.franchiseName === '') {
            ...
            this.props.firebase.createFranchise({
                ...
                .then((res) => {
                    ...
                    this.props.history.push(`/${this.state.franchiseSlug}/admin/content-management`)
...
const CreateFranchise = connect(mapStateToProps, mapDispatchToProps)(withFirebase(CreateFranchiseBase));
