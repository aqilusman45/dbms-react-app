...
class SiderDasboardBase extends Component {
  constructor(props) {
    super(props);
              ...
              if (authUser.userrole === 'admin') {
                return (
                  ...
                  <li className="ant-menu-item" role="menuitem" style={{paddingLeft: "24px"}}><Link to={`/admin/members`}><i
                    ...
                    </svg></i><span className="side-bar-menu-link">Admin Panel</span></Link></li>
...
const SiderDasboard = withRouter(withFirebase(SiderDasboardBase));
